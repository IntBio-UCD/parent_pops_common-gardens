...
write_csv(results, "../output/WL2_Traits/WL2_Growth_RptMeas_Results.csv")
...
random_fit2b_WL2.predictions %>% ggplot(aes(x=day)) +
  ...
  #scale_color_brewer(type="qual", palette = "Set2", guide="none") +
  facet_wrap(~parent.pop)
ggsave("../output/WL2_Traits/WL2_Growth_Predictions_HmaxRptMeas.png", width = 14, height = 8, units = "in")
```
...
summary(random_fit2b_WL2)
#rhat good 
#hmax intercept ESS kind of low (876)
