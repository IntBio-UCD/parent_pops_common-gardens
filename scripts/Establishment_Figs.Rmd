...
wl2_est_FIG_recent <- ggarrange(WYCD_recent, "", 
                                ...
                                font.label = list(size=30, 
                                                  face = "plain"), 
                                ncol=2, nrow=2) 
ggsave("../output/WL2_Traits/WL2_Estab_RecentDist.png", width = 24, height = 18, units = "in")
```
...
wl2_establishment %>% 
  ...
  theme(text=element_text(size=25), axis.text.x = element_text(angle = 45,  hjust = 1))
#ggsave("../output/WL2_Traits/WL2_Establishment_GeoDist.png", width = 8, height = 5, units = "in")
```
