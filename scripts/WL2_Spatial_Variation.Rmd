...
-   Models with bed & temp/moisture as a fixed predictor of fitness 
...
summary(est_mod_2)
#Interpretation: The coefficients for A:B will represent the differences in Y for each row within each bed, relative to the baseline level of bed

#min_temp_2023_model - could either use the full year averages for each bed (only two in 2023) or could use the first three weeks or just see if the model results match differences in temp/moisture?
```
