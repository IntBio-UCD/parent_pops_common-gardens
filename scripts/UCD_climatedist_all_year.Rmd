...
```{r}
cwd_calc <- function(data, P) { #function with all of the code necessary for calculating cwd 
...
#cwd_calc(home_climates_all_recent, 14) #the function works

cwd.boot <- boot(data=home_climates_all_recent, cwd_calc, R=1000, P=14) #I'm not sure why this isn't working 
