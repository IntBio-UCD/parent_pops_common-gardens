...
ggsave("../output/Climate/all_year_Sub_dist_from_Davis_Recent.png", width = 24, height = 24, units = "in")
...
ggsave("../output/Climate/all_year_Sub_dist_from_Davis_Historical.png", width = 24, height = 24, units = "in")
```

## Combine all Subtraction data
```{r}
recent_sub_dist_from_Davis <- full_join(recent_flint_dist, recent_bioclim_dist)
write_csv(recent_sub_dist_from_Davis, "../output/Climate/full_year_Subtraction_Dist_from_Davis_Recent.csv")

historic_sub_dist_from_Davis <- full_join(historic_flint_dist, historical_bioclim_dist)
write_csv(historic_sub_dist_from_Davis, "../output/Climate/full_year_Subtraction_Dist_from_Davis_Historical.csv")
```