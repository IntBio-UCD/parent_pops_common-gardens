...
To do: Change this to be climate distance from 2022-2023 water year. 
...
```{r}
davis_climate$month <- factor(davis_climate$month, levels = c("jan", "feb", "mar", "apr", "may", "jun", "jul", "aug", "sep", "oct", "nov","dec"))
