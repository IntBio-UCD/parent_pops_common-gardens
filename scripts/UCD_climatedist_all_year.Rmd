...
```{r}
gowers_calc <- function(data, indices=1:nrow(data), P) { #function with all of the code necessary for calculating gowers distance 
  ...
  range_merge <- range_merge[indices, ] # subset per bootstrap indices
...
magrittr::extract(1) # get a single value   
   
   }

#gowers_calc(home_climates_all_recent, P=14) #the function works

gowers.boot <- boot(data=home_climates_all_recent, statistic=gowers_calc, R=1000, P=14) #I'm not sure why this isn't working 

boot.ci(gowers.boot, type="norm")
```
