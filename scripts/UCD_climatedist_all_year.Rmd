...
```{r}
gowers_calc <- function(data, P) { #function with all of the code necessary for calculating gowers distance 
...
#gowers_calc(home_climates_all_recent, 14) #the function works
