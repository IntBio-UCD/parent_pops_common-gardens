...
wl2_establishment_sub_dist %>% 
  ...
  theme_classic() + 
  scale_y_continuous(expand = c(0.01, 0)) +
  labs(y="Establishment", x="Recent Water Year CWD Dist", 
       color="Elevation (m)") +
  theme(text=element_text(size=30))
```
...
![](Establishment_Figs_files/figure-html/unnamed-chunk-13-1.png)<!-- -->
...
wl2_establishment_sub_dist %>% 
  ...
  theme_classic() + 
  scale_y_continuous(expand = c(0.01, 0)) +
  labs(y="Establishment", x="Historic Water Year CWD Dist", 
       color="Elevation (m)") +
  theme(text=element_text(size=30))
```
...
![](Establishment_Figs_files/figure-html/unnamed-chunk-13-2.png)<!-- -->
...
wl2_establishment_sub_dist %>% 
 ...
 # annotate("text", x = 12.1639444	, y= 0.65, label = "WL2", 
  ...
  theme_classic() + 
  scale_y_continuous(expand = c(0.01, 0)) +
  labs(y="Establishment", x="Recent Growth Season CWD Dist", 
       color="Elevation (m)") +
  theme(text=element_text(size=30))
```
...
![](Establishment_Figs_files/figure-html/unnamed-chunk-14-1.png)<!-- -->
...
wl2_establishment_sub_dist %>% 
 ...
 # annotate("text", x = 8.9845278		, y= 0.65, label = "WL2", 
  ...
  theme_classic() + 
  scale_y_continuous(expand = c(0.01, 0)) +
  labs(y="Establishment", x="Historic Growth Season CWD Dist", 
       color="Elevation (m)") +
  theme(text=element_text(size=30))
```
...
![](Establishment_Figs_files/figure-html/unnamed-chunk-14-2.png)<!-- -->
...
## # A tibble: 23 × 4
## # Groups:   pop [23]
##    pop   elev_m meanEst semEst
##    <chr>  <dbl>   <dbl>  <dbl>
##  1 WV      749.   0     0     
##  2 LV1    2593.   0.264 0.0464
##  3 LVTR1  2741.   0.264 0.0464
##  4 WR     1158    0.286 0.125 
##  5 YO8    2591.   0.319 0.0491
##  6 LV3    2354.   0.333 0.0925
##  7 SQ2    1934.   0.344 0.0613
##  8 FR      787    0.354 0.0698
##  9 YO11   2872.   0.385 0.0513
## 10 CP3    2266.   0.385 0.0513
## # ℹ 13 more rows
```

``` r
wl2_establishmen_adapt <- wl2_establishment %>% filter(pop=="WL2" | pop=="IH")

adaptlagm1 <- glmer(Establishment ~ pop + (1|block), data=wl2_establishmen_adapt, family = binomial)
summary(adaptlagm1) #pop not significant...
```
...
## Formula: Establishment ~ pop + (1 | block)
##    Data: wl2_establishmen_adapt
## 
##      AIC      BIC   logLik deviance df.resid 
##    246.7    256.4   -120.4    240.7      180 
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -1.6155 -1.1094  0.6398  0.7661  1.1091 
## 
## Random effects:
##  Groups Name        Variance Std.Dev.
##  block  (Intercept) 0.1455   0.3814  
## Number of obs: 183, groups:  block, 13
## 
## Fixed effects:
##             Estimate Std. Error z value Pr(>|z|)   
## (Intercept)   0.7033     0.2496   2.818  0.00483 **
## popWL2       -0.3984     0.3114  -1.279  0.20076   
## ---
