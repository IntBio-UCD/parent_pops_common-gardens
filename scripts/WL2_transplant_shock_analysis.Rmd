...
```{r results='hide'}
size_0726 <- read_csv("../input/WL2_Data/WL2_size_survey_20230726_corrected.csv")
summary(size_0726)
head(size_0726)
...
mort_0726 <- read_csv("../input/WL2_Data/WL2_Mort_pheno_survey_20230726_corrected.csv")
summary(mort_0726)
head(mort_0726)
mort_0726_names <- mort_0726 %>% select(block:bud.date, death.date)

size_preplant_1 <- read_csv("../input/WL2_Data/WL2_DNA_Collection_Size_survey_combined20230703_corrected.csv")
summary(size_preplant_1)
names(size_preplant_1)

size_preplant_extras <- read_csv("../input/WL2_Data/WL2_Extras_DNA_collection_size_survey_combined20230706_corrected.csv")
