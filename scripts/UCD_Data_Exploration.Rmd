...
pop_elev <- read_csv("../input/UCD_Data/Pops_for_2022_UCD.csv")
summary(pop_elev)
pop_elev_nonotes <- pop_elev %>% select(-notes)
pop_elev_nonotes

anncensusgerm <- read_csv("../input/UCD_Data/Annual_census_germination_20230626_corrected.csv")
head(anncensusgerm)
...
anncensustrans_0522 <- read_csv("../input/UCD_Data/Annual_Census_Transplants_20230522_corrected.csv")
...
anncensustrans_0626 <- read_csv("../input/UCD_Data/Annual_Census_transplants_20230626_corrected.csv")
...
```{r}
germsurvey_0127 = read_csv("../input/UCD_Data/Germination_survey_20230127_corrected.csv")
summary(germsurvey_0127)
head(germsurvey_0127)

germsurvey_0210 = read_csv("../input/UCD_Data/Germination_survey_20230210_corrected.csv")
summary(germsurvey_0210)
head(germsurvey_0210)

germsurvey_0508 = read_csv("../input/UCD_Data/Germination_survey_20230508_corrected.csv")
...
```{r}
mortsurvey <- read_csv("../input/UCD_Data/Mortality_survey_20230217_corrected.csv")
...
```{r}
pheno_germs <- read_csv("../input/UCD_Data/Phenology_survey_germination_20230515_corrected.csv")
summary(pheno_germs)
head(pheno_germs)
```
...
ucd_garden_size_1128 <- read_csv("../input/UCD_Data/UCD_garden_size_measurements_20221128_corrected.csv")
