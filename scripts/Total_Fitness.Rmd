...
plot(wl2_total_fitness_gs_mod1, which = 1) #residuals vs. fitted plot, seems to be a pattern --> bad 
qqnorm(resid(wl2_total_fitness_gs_mod1))
qqline(resid(wl2_total_fitness_gs_mod1))  # points do not fall nicely on the line --> bad (long tail)
...
qqline(resid(wl2_total_fitness_wy_mod1))  # points do not fall nicely on the line --> bad (long tail)
```
...
qqline(resid(ucd_total_fitness_gs_mod1))  # points do not fall nicely on the line --> bad (tail on both ends)
...
qqline(resid(ucd_total_fitness_wy_mod1))  # points do not fall nicely on the line --> bad (tail on both ends)
```
