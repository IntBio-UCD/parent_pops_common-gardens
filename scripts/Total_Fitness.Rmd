...
wl2_rep_output <- wl2_total_fitness_scaled %>% 
  ...
  mutate(Total_Fitness_Scaled=Total_Fitness/mean(Total_Fitness))
#wl2_rep_output
...
mod_test <- glmer.nb(Total_Fitness_Scaled ~ (1|pop) + (1|block), data=wl2_rep_output)
plot(mod_test, which = 1) 
qqnorm(resid(mod_test))
qqline(resid(mod_test)) 
#non-integer warnings with these models!
```
