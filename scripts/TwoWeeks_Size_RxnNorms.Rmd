...
twowks_surv_mfs_wide <- twowks_rxnnorms_loc %>% 
...
twowks_surv_mfs_bothsites <- left_join(twowks_surv_mfs_wide, twowks_rxnnorms_loc)

mf_sample_size <- twowks_surv_mfs_bothsites %>% 
...
mf_per_pop <- twowks_surv_mfs_bothsites %>% 
