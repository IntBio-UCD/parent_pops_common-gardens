...
pop_elev_climate_60 <- pop_elev_climate %>% 
  ...
  mutate(grow_yr = year + month %in% c(9:12)) %>% #match water year to grow months 
...
snow_60_last_month_col %>% filter(is.na(lastmonth)) #232 cases where there isn't a lastmonth 
...
snow_60_last_month_col %>% filter(lastmonth==firstmonth+2) #12 case where there was sig snowpack in the second month after the first month of 0 snowpack 
