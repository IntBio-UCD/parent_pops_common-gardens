...
#practice_0830 <- read_csv("../input/WL2_size_survey_20230830_corrected.csv")
#names(practice_0830) 
#names(practice_0830) <- gsub(" ","", colnames(practice_0830))
#head(practice_0830)
#practice_0830 %>% filter(herbiv.y.n != "Y" & herbiv.y.n != "N")
#practice_0830$herbiv.y.n <- str_to_upper(practice_0830$herbiv.y.n)
```
